...
To install the font simply execute the file called ReffsPixelFont.ttf and follow the instructions in the prompt. This is a True Type Font.

A file called ReffsPixelFont.otf is also provided for compatibility reasons, but this font does not include any Open Type exclusive functionality.
